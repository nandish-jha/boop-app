...
- **v1.0.5** (current): [releases/prodash-v1.0.5.apk](releases/prodash-v1.0.5.apk) — native Android notification bridge, per-task reminders with date+time, SVG edit/close icons
