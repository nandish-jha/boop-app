...
- **v1.0.10** (current): [releases/prodash-v1.0.10.apk](releases/prodash-v1.0.10.apk) — full flat redesign (no glass UI) with improved information hierarchy and auto-sync Android web assets
