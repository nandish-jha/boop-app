...
- **v1.0.4** (current): [releases/prodash-v1.0.4.apk](releases/prodash-v1.0.4.apk) — full CRUD on habits, supplements, skincare, workouts, accounts, categories + iOS liquid-glass UI
